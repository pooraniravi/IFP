...
//BUGS:1.Doesnt work in one of the four conditions of initial positions of bot and bins 2.Doesnt work when obstacle is immediately next to bot initially
char directions[30];
#include<SoftwareSerial.h>
SoftwareSerial xBeep(12,13);
int i=0;
int fdelay=1000;
int udelay=1000;
int trdelay=569;
